...
public class TakeSnapshot {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Enter lastName successfully");
			...
			//File dest = new File("C:\\Users\\harun\\snap\\image1.png");//define the destination file
			
			//path/destination-2, where it will store after moved
			File dest = new File("./snap/harun2.png");
